...
import dog_breed_identifier  # Import your dog prediction program

app = Flask(__name__)
auth = HTTPBasicAuth()

# Hardcoded username and password (replace with secure storage in production)
USERNAME = 'client'
...
def predict_dog():
    ...
    epochs = int(request.form.get('epochs', 1))  # Default to 1 if not provided

    # Print the number of epochs received
    print("Number of epochs received:", epochs)

    # Call your prediction function with the specified epochs
